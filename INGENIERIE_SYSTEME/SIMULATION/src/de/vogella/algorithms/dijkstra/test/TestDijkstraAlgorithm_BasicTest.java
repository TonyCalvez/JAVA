...
public class TestDijkstraAlgorithm_BasicTest {

  private List<IVertex> nodes;
  private List<IEdge> edges;
  
  public static void main(String[] args) {
	TestDijkstraAlgorithm_BasicTest tda = new TestDijkstraAlgorithm_BasicTest();
	tda.testExcute();
}
  ...
  public void testExcute() {
    ...
    LinkedList<IVertex> path = dijkstra.getPath(nodes.get(1));
