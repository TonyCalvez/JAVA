...
//    final DrawnGroup drawnGroup = new DrawnGroup();
	...
	protected void buildCamera(Group root, Point3D cameraPos, Point3D directionOfView) {
		...
		//fondamental ci-dessous: r�orienter la cam�ra qui par d�faut est orient�e vers le haut selon l'axe z et l'axe des x et y ne sont pas non plus bien orient�s 
		ry.setAngle(90);
		rz.setAngle(-90);
	...
	void moveAbsoluteByRotation(Point3D cameraPos, Point3D angleOfView) {
		...
		// mise � jour de l'�tat de positionnement camera
		axyz = angleOfView;
		pointVue = cameraPos;
