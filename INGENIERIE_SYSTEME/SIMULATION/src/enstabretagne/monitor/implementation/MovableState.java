...
public class MovableState implements IMovable {
	...
	/*
	 * rotationXYZ exprime : 
	 * - en x, l'angle de rotation en degr�s selon l'axe des x
	 * - en y, l'angle de rotation en degr�s selon l'axe des y
	 * - en z, l'angle de rotation en degr�s selon l'axe des z
	 */
	Point3D rotationXYZ;
	/*
	 * rotationXYZ exprime : 
	 * - en x, la vitesse de rotation en degr�s selon l'axe des x
	 * - en y, la vitesse de rotation en degr�s selon l'axe des y
	 * - en z, la vitesse de rotation en degr�s selon l'axe des z
	 */
