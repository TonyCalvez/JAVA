...
public class SimEngine implements ISimEngine{
        ...
        public SimEngine(){
        	...
        	//TODO v�rifier ces deux trucs ci dessous
            // Initialise fields
...
//            this.initialCalendarDate = monitor.InitialCalendarDate();
        ...
        public void init(IScenario currentScenario, SimScenarioInit initScenario)
        {
            ...
            Logger.Information(getCurrentScenario(),"SimEngine - Generator", "G�n�rateur cr�� avec la graine "+((int) getCurrentScenario().getSeed()));
