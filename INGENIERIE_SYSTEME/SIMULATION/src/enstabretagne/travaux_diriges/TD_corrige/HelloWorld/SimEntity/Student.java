...
public class Student extends SimEntity{
	...
	public void talkTo(Student whoIsSpeaking,String message) {
		double d = RandomGenerator().nextUniform(2, 6);//on r�pond entre 2 et 6 secondes.
		LogicalDuration ld = LogicalDuration.ofSeconds(d);
		Post(new RepondreEvent(whoIsSpeaking),ld);
		Logger.Information(this, "talkTo", whoIsSpeaking.getNom() + " vient de me dire : "+ message+ " et je vais lui r�pondre dans "+ld);
	}
	...
	protected void AfterTerminated(IEntity sender, boolean restart) {
		Logger.Information(this, "AfterTerminated", this.getName()+" est termin�");
	}
	...
	public class RepondreEvent extends SimEvent {
		...
		@Override
		public void Process() {
			Logger.Information(Owner(), "RepondreEvent.Process", getNom() + " r�pond � "+destinataire.getNom());
