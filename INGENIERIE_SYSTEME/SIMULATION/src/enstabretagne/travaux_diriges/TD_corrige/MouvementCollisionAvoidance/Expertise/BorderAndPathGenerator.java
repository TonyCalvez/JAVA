...
public class BorderAndPathGenerator {
	...
	//Algorithme utilisant la nappe de points g�n�r�e plus bas, l'espace avec lequel la nappe a �t� d�finit
	//il g�n�re les liens entre les points de la nappe directement adjacents qui sont en intervisibilit�
	...
	//g�n�r�re une nappe de points autour de ces murs sans passer dans les murs
	//notez que le premier argument n'est pas utilis�... c'est pour une version ult�rieure de l'algo
	//le deuxi�me argument permet de d�finir la r�solution de la nappe
	...
	//Algorithme permettant de g�n�rer un chemin de points longeant les murs	
...
//					Logger.Detail(null, "Border 0", "PF="+pf1.toString());
	...
	//Algorithme prenant deux points de m�me altitude et g�n�re un cylindre les reliant
	...
	//Permet de v�rifier s'il y a intersection entre un cylindre et une liste de boites englobantes
	...
	//Permet de v�rifier l'intervisibilit� entre deux points selon un ensemble de boites englobantes
