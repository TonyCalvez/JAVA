...
public class ScenarioInstanceBasicMovement5 implements IScenarioInstance {
	...
	public IScenario getScenarioInstance(long seed) {
		...
		BasicMvtScenario bms = new BasicMvtScenario(new ScenarioId("S1 D=5.2 N=2"), bsf, start, end);
